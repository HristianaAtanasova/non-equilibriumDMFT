...
def Solver(Delta, U, init, Green_):
    ...
    Green_[0] = (Green[0, 0, 0, :, len(t)-1] + Green[0, 0, 1, :, len(t)-1] + Green[0, 0, 2, :, len(t)-1] + Green[0, 0, 3, :, len(t)-1])/4
    Green_[1] = (Green[1, 0, 0, :, len(t)-1] + Green[1, 0, 1, :, len(t)-1] + Green[1, 0, 2, :, len(t)-1] + Green[1, 0, 3, :, len(t)-1])/4

    # Green_[0] = Green[0, 0, init, :, len(t)-1]
    # Green_[1] = Green[1, 0, init, :, len(t)-1]
